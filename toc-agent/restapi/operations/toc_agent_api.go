...
// NewTocAgentAPI creates a new TocAgent instance
func NewTocAgentAPI(spec *loads.Document) *TocAgentAPI {
	return &TocAgentAPI{
		...
		TransferGetTransferHandler: transfer.GetTransferHandlerFunc(func(params transfer.GetTransferParams) middleware.Responder {
			return middleware.NotImplemented("operation transfer.GetTransfer has not yet been implemented")
		}),
...
/*TocAgentAPI Worker API to create backup and restoration */
type TocAgentAPI struct {
	spec            *loads.Document
	...
	// TransferGetTransferHandler sets the operation handler for the get transfer operation
	TransferGetTransferHandler transfer.GetTransferHandler
...
func (o *TocAgentAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *TocAgentAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *TocAgentAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *TocAgentAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *TocAgentAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *TocAgentAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *TocAgentAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *TocAgentAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *TocAgentAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the TocAgentAPI
func (o *TocAgentAPI) Validate() error {
	...
	if o.TransferGetTransferHandler == nil {
		unregistered = append(unregistered, "transfer.GetTransferHandler")
	}
...
func (o *TocAgentAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *TocAgentAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
	return nil
}

// Authorizer returns the registered authorizer
func (o *TocAgentAPI) Authorizer() runtime.Authorizer {
	return nil
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *TocAgentAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *TocAgentAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *TocAgentAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the toc agent API
func (o *TocAgentAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *TocAgentAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/transfers"] = transfer.NewGetTransfer(o.context, o.TransferGetTransferHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
...
func (o *TocAgentAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *TocAgentAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *TocAgentAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *TocAgentAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
