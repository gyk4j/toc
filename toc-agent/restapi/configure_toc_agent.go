...
import (
	...
	"github.com/gyk4j/toc/toc-agent/controllers"
	"github.com/gyk4j/toc/toc-agent/restapi/operations"
	"github.com/gyk4j/toc/toc-agent/restapi/operations/backup"
	"github.com/gyk4j/toc/toc-agent/restapi/operations/restoration"
	"github.com/gyk4j/toc/toc-agent/restapi/operations/transfer"
)

//go:generate swagger generate server --target ..\..\api --name TocAgent --spec ..\swagger.yaml --principal interface{}

func configureFlags(api *operations.TocAgentAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.TocAgentAPI) http.Handler {
	...
	api.TransferGetTransferHandler = transfer.GetTransferHandlerFunc(controllers.GetTransfers)
