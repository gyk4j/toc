...
func (fn NewBackupHandlerFunc) Handle(params NewBackupParams) middleware.Responder {
	return fn(params)
}
...
func NewNewBackup(ctx *middleware.Context, handler NewBackupHandler) *NewBackup {
	return &NewBackup{Context: ctx, Handler: handler}
}
