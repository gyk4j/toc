...
func (fn GetBackupsHandlerFunc) Handle(params GetBackupsParams) middleware.Responder {
	return fn(params)
}
...
func NewGetBackups(ctx *middleware.Context, handler GetBackupsHandler) *GetBackups {
	return &GetBackups{Context: ctx, Handler: handler}
}
...
func (o *GetBackups) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetBackupsParams()
